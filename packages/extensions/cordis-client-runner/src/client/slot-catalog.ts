...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-runstate (props) => RunstateToggle({ ...props, toggle: () => toggl…',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-runstate RunstateBody',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-runstate RunstateReviewBadge',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'tool.call.review\', () => ctx.slots.register(\n      { name: \'tool.call.review\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-tool/src/client/contract/slots.ts:47',
  },
  {
